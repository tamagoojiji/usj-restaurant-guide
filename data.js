...
const RESTAURANTS = [
  ...
  },
  {
    ...
    collab: null,
    collabMenu: null,
    features: "恐竜テーマのバーガーメニューにリニューアル。メインエリアから少し離れた穴場。",
    foodCategories: ["ハンバーガー", "デザート・スイーツ"]
  },
  {
    id: "louis",
  ...
  },
  {
    ...
    collab: null,
    collabMenu: null,
    features: "マリオの世界観を再現。キノコやスター型のキャラクターフードが楽しめる。入場方法は①フリー入場（そのまま並ぶ）②整理券（混雑時・店舗前QRコードから取得）の2パターン。",
  ...
  },
  {
    ...
    capacity: "中程度",
    peakTime: "11:00〜13:30",
    recommendedTime: "10:30がおすすめ。基本的に当日予約制（店舗前QRコード）",
    crowdLevel: "穴場",
    character: null,
    ...
    collab: null,
    collabMenu: null,
    features: "パーク内の高級レストラン。落ち着いた雰囲気でゆっくり食事できる。事前予約（TableCheck・1ヶ月前〜）・当日予約（店舗前QRコード）可能。",
  ...
  },
  {
    ...
    capacity: "中程度",
    peakTime: "11:00〜13:30",
    recommendedTime: "10:30がおすすめ。事前予約（TableCheck）or 当日予約（店舗前QRコード）推奨",
    crowdLevel: "普通",
    character: null,
    ...
    collab: null,
    collabMenu: null,
    features: "パーク内唯一の本格和食レストラン。御膳スタイルで洋食に飽きた時に重宝。事前予約（TableCheck・1ヶ月前〜）・当日予約（店舗前QRコード）可能。混雑少なめだが予約推奨。",
